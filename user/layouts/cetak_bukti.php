          ...
          <div class="box box-widget widget-user-2">
            ...
            <?php foreach($terima as $trm) : ?>
              <ul class="nav nav-stacked">
                    ...
                    <li><a href="#">Nama Orang Tua <span class="direct-chat-text bg-teal"><i class="fa fa-university"></i> <?php echo $trm['nama_ayah'] ?></span></a></li>
                    <li><a href="#">No Kartu Keluarga  <span class="direct-chat-text bg-teal"><i class="fa fa-tasks"></i> <?php echo $trm['no_kk'] ?> </span></a></li>
                    <li><a href="#">Diterima pada program <span class="direct-chat-text bg-teal"><i class=" fa-hand-o-righ"></i> <?php echo $trm['nama_program'] ?></span></a></li>         
              </ul>
              <?php endforeach ?>
            </div>
          </div>
